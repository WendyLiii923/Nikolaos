            ...
            <div class="col-sm-9 col-md-9 ">
                <div class="form-group">
                    ...
                    <form:input class="form-control" type="text" name="email" id="email"
                        placeholder="請輸入帳號(email)" path="email" required="reqired" />
<%--                 <form:input type='text' path='email' /><br>&nbsp; --%>
                ...
                <div class="form-group">
                    <!--        輸入姓名框           -->
                    <i class="fa fa-user" aria-hidden="true"></i>
                    <form:input class="form-control" type="text" name="name" id="name" placeholder="請輸入姓名" required="reqired" path='name' />
...
<%--                     <form:input path='address' /><br>&nbsp; --%>
                ...
                <div class="form-group">
                    ...
                    <form:input class="form-control" type="password" name="password" id="password"
                        placeholder="請輸入密碼" required="reqired" path="password"/>
...
<%--       				<form:errors path="password" />  --%>
                ...
                <div class="form-group">
                    ...
                    <form:input class="form-control" type="password" name="password1" id="password1"
                        placeholder="再次輸入密碼" required="reqired" path="password1"/>
...
<%--  					<form:errors path="password1" /> --%>
               ...
               <div class="form-group">
                ...
                <div class="form-group align-items-baseline">
                    ...
                    <a class="btn btn-primary pull-left" href="./login.html">返回登入畫面</a>
