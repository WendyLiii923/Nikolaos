...
<%--       		<form:input path='memberId' class="fieldWidth" style="width: 200px;"/><br>&nbsp; --%>
...
<!--       	</td> -->
      	...
      	<td>
      		<form:input path='name'  class="fieldWidth" style="width: 200px;"/><br>&nbsp;
      ...
      <tr height="52">
        <td> 
      	...
      	<td>
      		<form:input path='password' class="fieldWidth" style="width: 200px;"/><br>&nbsp;
        ...
        <td>
      	...
      	<td>	
      		<form:input path='password1' class="fieldWidth" style="width: 200px;"/><br>&nbsp;
     ...
     <tr height="52">
     	<td>
      	...
      	<td>	
      		<form:input path='address' class="fieldWidth" style="width: 200px;"/><br>&nbsp;
      	...
      	<td>	
      		<form:input type='text' path='phone' class="fieldWidth" style="width: 200px;"/><br>&nbsp;
      ...
      <tr height="52">
      	...
      	<td>	
      		<form:input type='text' path='email' class="fieldWidth" style="width: 200px;"/><br>&nbsp;
